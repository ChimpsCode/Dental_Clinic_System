<?php
/**
 * Staff Billing - View and manage billing for patients from the queue
 * Shows patients from queue with their billing/payment status
...
?>
            <div class="content-main">
                ...
                <div class="page-header">
                    ...
                    <p class="page-subtitle">View and manage billing for patients from the queue</p>
                </div>
                ...
                <div class="search-filters">
                    <form method="GET" class="filter-form" id="filterForm">
                        <input type="text" class="search-input" placeholder="Search by patient name or treatment..." 
                               name="search" id="billingSearch" value="<?php echo htmlspecialchars($searchQuery); ?>">
                                ...
                                <td class="action-cell">
                                    <div class="kebab-menu">
                                        ...
                                        <div class="kebab-dropdown">
                                            <button class="kebab-item" onclick="viewBillingDetails(<?php echo $record['queue_id']; ?>, <?php echo $record['patient_id']; ?>)">
            ...
            <div id="billingModal" class="modal-overlay" style="display: none;">
                <div class="modal">
                    ...
                    <div class="modal-body" id="billingModalContent">
                        <!-- Content loaded dynamically -->
                    </div>
                    <div class="modal-actions">
                        <button type="button" class="btn-cancel" onclick="closeBillingModal()">Close</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="payment-details">
                            <div class="detail-row">
                                ...
                                <span class="detail-value" id="paymentAmount">P0.00</span>
                            </div>
                            <div class="detail-row">
                                <span class="detail-label">Treatment:</span>
                                <span class="detail-value" id="paymentTreatment">-</span>
                            </div>
                        </div>
                        <input type="hidden" id="paymentQueueId">
                        <input type="hidden" id="paymentPatientId">
                        <input type="hidden" id="paymentAmountValue">
                        <input type="hidden" id="paymentTreatmentValue">
                    </div>
                    <div class="modal-actions">
            ...
            <script>
                ...
                function viewBillingDetails(queueId, patientId) {
                    // Close kebab menu
                ...
                function markAsPaid(queueId, patientId, amount, treatment) {
                    ...
                    // Set modal values
                    document.getElementById('paymentQueueId').value = queueId;
                    document.getElementById('paymentPatientId').value = patientId;
                    document.getElementById('paymentAmountValue').value = amount;
                    document.getElementById('paymentTreatmentValue').value = treatment;
                    document.getElementById('paymentAmount').textContent = 'P' + parseFloat(amount).toFixed(2);
                    document.getElementById('paymentTreatment').textContent = treatment || 'General Checkup';
                ...
                function confirmPayment() {
                    const queueId = document.getElementById('paymentQueueId').value;
                    const patientId = document.getElementById('paymentPatientId').value;
                    const amount = document.getElementById('paymentAmountValue').value;
                    const treatment = document.getElementById('paymentTreatmentValue').value;
                ...
                document.getElementById('billingSearch').addEventListener('keypress', function(e) {
                    if (e.key === 'Enter') {
