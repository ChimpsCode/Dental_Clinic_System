...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="#" class="nav-item">
                <span class="nav-item-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2L2 7v6c0 5 3.8 9.7 10 13c6.2-3.3 10-8 10-13V7l-10-5zM12 9a3 3 0 1 1 0 6a3 3 0 0 1 0-6z"/></svg></span>
